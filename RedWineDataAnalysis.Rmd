...
p1 = ggplot(aes(x = fixed.acidity), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = fixed.acidity ), data = ws) + 
...
p1 = ggplot(aes(x = residual.sugar), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = residual.sugar ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
...
p1 = ggplot(aes(x = chlorides), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = chlorides ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
...
p1 = ggplot(aes(x = free.sulfur.dioxide), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = free.sulfur.dioxide ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
...
p1 = ggplot(aes(x = total.sulfur.dioxide), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = total.sulfur.dioxide ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
...
p1 = ggplot(aes(x = density), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = density ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
...
p1 = ggplot(aes(x = pH), data = ws) + 
  geom_histogram(color = I("black"), fill = I("#099DD9"))
p2 = ggplot(aes( x = 1, y = pH ), data = ws) + 
               geom_jitter(alpha = 0.1) +
               geom_boxplot(alpha = 0.2, color = "#099DD9")
grid.arrange(p1, p2, ncol=2)
```
